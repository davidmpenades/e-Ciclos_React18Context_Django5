              ...
              <div className="lg:w-1/2 md:w-full md:pr-10 md:py-6">
                <div className="flex relative pb-12">
                  ...
                  <div className="flex-grow pl-4">
                    ...
                    <p className="leading-relaxed">
                      Registrate en nuestra plataforma, para poder acceder a
                ...
                <div className="flex relative pb-12">
                  ...
                  <div className="flex-grow pl-4">
                    ...
                    <p className="leading-relaxed">
                      Elige entre uno de nuestros planes, para poder acceder a
                      las bicicletas.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex relative pb-12">
                  ...
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-green-500 inline-flex items-center justify-center text-white relative z-10">
                    <img src={bici} alt="Tu icono" className="w-5 h-5" />
                  </div>
                  <div className="flex-grow pl-4">
                    <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">
                      Paso Cuatro
                ...
                <div className="flex relative">
                  ...
                  <div className="flex-grow pl-4">
                    ...
                    <p className="leading-relaxed">
                      Deja la bicicleta en una de nuestras estaciones y escanea
                      el codigo QR para bloquearla.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap w-full">              
              <div className="lg:w-1/2 md:w-full md:pr-10 md:py-6">                
                <div className="flex relative pb-12">                  
                  ...
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-green-500 inline-flex items-center justify-center text-white relative z-10">
                    <img src={qr} alt="Tu icono" className="w-5 h-5" />
                  </div>
                  <div className="flex-grow pl-4">
                    <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">
                      Primer paso
