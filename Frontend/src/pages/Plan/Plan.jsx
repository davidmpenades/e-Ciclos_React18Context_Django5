...
export default function Plan() {
  ...
  return (
    <div
      className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8 p-4 lg:p-8 min-h-screen"
      style={divStyle}
    >
      <h1
        className="text-center m-20 rounded-lg text-4xl bg-white p-5 shadow-xl"
        style={{ fontFamily: "CustomFont" }}
      >
        {" "}
        Empieza. Elige el plan que mejor se adapte a ti
      </h1>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8 p-4 lg:p-8">
        <div className="mb-8">
