...
export default function ModalAdd({ add, station={ id:'', slug:'', name:'', num_bikes:'', latitude:'', longitude:'', status:'', img_st:''}, modalType, updateStation}) {
  ...
  const TypeModal = modalType === "add" ? "Add" : "Update";
  ...
  return (
    <>                   
        <Button onClick={() => setOpenModal(true)} color={ColorButton}>
          {TypeModal}
        </Button>
